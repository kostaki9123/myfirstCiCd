...
const Amounts = () => {
  return (
    <div className='bg-[#ACA7CB] p-2 rounded-md    base:row-start-1 base:row-end-2 base:col-start-1 base:col-end-2    535:row-start-1 535:row-end-2 535:col-start-1 535:col-end-2    986:row-start-1 986:row-end-5 986:col-start-1 986:col-end-2  '>
           <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
             Amounts
           </h4>

           <div className=' border-2 border-red-50 flex w-full h-[214px] flex-col items-center justify-center gap-[30px]'>
