  ...
  return (
    <div className=" absolute top-0 inset-0 flex items-start justify-start overflow-x-hidden 535:overflow-x-auto bg-[#010038] "> 
      <div className="relative   flex items-start justify-start   h-full w-full">   
        <div className=" flex 535:flex-col flex-col 535:mt-0 relative  w-full   xxs:w-9   xxs:max-w-[200px]  535:max-w-content   justify-start items-start   gap-2 min-w-max p-6  ">
            ...
            <div className="flex w-full gap-12 ">
               ...
               <Card className=" w-full p-2 535:max-w-[370px] bg-white/10  border border-white/10
